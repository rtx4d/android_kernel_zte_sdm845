...
#define SCHG_USB_HVDCP_PULSE_COUNT_MAX	(USBIN_BASE + 0x5B)
/*Maximum QC2.0 Pulse Count (00 = 5V, 01 = 9V, 10 = 12V, 11 =NA)*/
#define HVDCP_PULSE_COUNT_MAX_QC2P0_HIGH_BIT	BIT(7)
#define HVDCP_PULSE_COUNT_MAX_QC2P0_LOW_BIT	BIT(6)
...
#define DC_INT_RT_STS		(DCIN_BASE + 0x10)
/* DCIN Interrupt Bits */
