...
static int zte_misc_set_ship_mode(const char *val, struct kernel_param *kp)
{
...
static int zte_misc_get_ship_mode(char *val, struct kernel_param *kp)
{
	struct power_supply *batt_psy;
	int rc;
...
static int driver_charging_policy_set(const char *val, struct kernel_param *kp)
{
	int rc;
...
static int driver_charging_policy_get(char *val, struct kernel_param *kp)
{
...
static int zte_misc_get_wireless_charging_signal(char *val, struct kernel_param *kp)
{
...
static int zte_misc_screen_on_set(const char *val, struct kernel_param *kp)
{
	int rc = 0;
	...
	if (batt_psy) {
		...
		if (rc) {
			pr_err("Can not set CHARGE_CONTROL_LIMIT %d\n", rc);
		}
	} else {
...
static int zte_misc_screen_on_get(char *val, struct kernel_param *kp)
{
